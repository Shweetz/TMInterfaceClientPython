...
def compute_dist_2_points_no_y(pos1, pos2):
    return math.sqrt((pos2[0]-pos1[0]) ** 2 + (pos2[2]-pos1[2]) ** 2)
...
class MainClient(Client):
    ...
    def on_bruteforce_evaluate(self, iface, info: BFEvaluationInfo) -> BFEvaluationResponse:
        ...
        if start_eval_time < self.current_time < 16000:
            ...
            # if self.phase == BFPhase.INITIAL:
                ...
                if self.phase == BFPhase.SEARCH:
                    ...
                    self.current_dist = compute_dist_2_points_no_y(position_optimized, pos)
