...
steer_diff = 65536
time_diff = 50
# rules.append(Rule(Input.STEER, Change.STEER_, proba=proba, start_time=start, end_time=end, diff=steer_diff))
# rules.append(Rule(Input.UP___, Change.TIMING, proba=proba, start_time=start, end_time=end, diff=time_diff))
# rules.append(Rule(Input.DOWN_, Change.TIMING, proba=proba, start_time=start, end_time=end, diff=time_diff))
# rules.append(Rule(Input.STEER, Change.TIMING, proba=0.5, start_time="0.00", end_time="4.00", diff=100))

rules.append(Rule(Input.STEER, Change.STEER_,  proba=0.02, start_time=43600, end_time=46010, diff=65536))
#rules.append(Rule(Input.STEER, Change.TIMING,  proba=0.02, start_time=43600, end_time=46010, diff=20))
