...
rules.append(Change(Input.STEER, ChangeType.STEER_DIFF,  proba=0.01, start_time=14520, end_time=18500, diff=65536))
...
rules.append(Change(Input.DOWN, ChangeType.TIMING, proba=0.05, start_time=14520, end_time=18500, diff=20))
...
class MainClient(Client):
    ...
    def is_custom(self, base_run, min_diff=0):
        ...
        self.car.custom = self.car.z + self.car.get_speed() * 0.2
