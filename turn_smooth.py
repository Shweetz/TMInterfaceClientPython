...
class MainClient(Client):
    ...
    def on_simulation_step(self, iface, _time: int):
        ...
        if self.simtime == self.working._time - 10:
            ...
            self.last_yaw = self.get_yaw(state)
            ...
            self.curr_yaw = self.get_yaw(state)
            ...
            if self.has_crashed():
                ...
                # print(f"{self.curr_yaw=}, {self.last_yaw=}")
    ...
    def has_crashed(self):
        ...
        # if self.curr_yaw > 0 and self.last_yaw < 0:
        #     return False
        # if self.curr_yaw < 0 and self.last_yaw > 0:
        #     return True
        # if self.curr_yaw < 0 and self.last_yaw < 0:
        #     return self.curr_yaw > self.last_yaw
        # if self.curr_yaw > 0 and self.last_yaw > 0:
        #     return self.curr_yaw > self.last_yaw
        # return False
    ...
    def get_yaw(self, state):
        return state.yaw_pitch_roll[0]
