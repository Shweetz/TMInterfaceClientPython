...
NEXT_EVAL = "none" # "none"/"speed"/"point"
#POINT = [523, 9, 458]
GOOD_BUGSLIDE_DEG = 10
...
class MainClient(Client):
    ...
    def is_better(self, iface: TMInterface):
        ...
        # if state.scene_mobil.is_freewheeling:
        #     return False
        ...
        if self.best.angle < GOOD_BUGSLIDE_DEG and self.curr.angle < GOOD_BUGSLIDE_DEG:
